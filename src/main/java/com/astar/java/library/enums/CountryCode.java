package com.astar.java.library.enums;
...
public enum CountryCode {
    //    TODO IMPLEMENT ALPHA 2 CODES
    UNDEFINED("Undefined", null, null, -1, Assignment.USER_ASSIGNED) {
        @Override
    ...
    private static final Map<String, CountryCode> alpha2Map = new HashMap<>();
    ...
    private CountryCode(
            String name, String alpha2, String alpha3, int numeric, Assignment assignment) {
        this.name = name;
        this.alpha2 = alpha2;
        this.alpha3 = alpha3;
